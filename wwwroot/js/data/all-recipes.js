const recipes = [
    {
        ...
        instructions: `<p>Heat oven to 190°C.</p>
            ...
            <br>
            <p>Place in preheated oven for 15 to 30 minutes (depending on thickness or shape) or until slightly brown on edges. Shortbread shouldn't be darkly coloured. Let your shortbread cool on the tray before moving to a rack to cool completely.</p>`,
    ...
    },
    {
        ...
        ingredients: `<ul>
            ...
            <li>115g unsalted butter, (8 Tbsp) at room temperature</li>
            ...
            <li>117g walnuts (optional topping)</li>
            <li>72.5g raisins (optional)</li>
        </ul>`,
    ...
    },
    {
        ...
        ingredients: `<ul>
            <li>500g fresh or frozen cranberries</li>
            <li>300g sugar</li>
            <li>2 teaspoon finely grated lemon zest</li>
            <li>3 tablespoon water</li>
            <li>160g Brown Sugar</li>
            <li>45g Dijon mustard</li>
            <li>45g red wine vinegar</li>
            <li>42g extra virgin olive oil</li>
            <li>30g finely chopped shallots</li>
